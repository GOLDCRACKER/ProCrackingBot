...
local function found_helper(TM, ProCracking)
...
tdcli.getInlineQueryResults(ProCracking.id_, msg.to.id, 0, 0, msg.to.id, 0, inline_query_cb, nil)
end
...
--end groupmanager.lua #ProCracking team#
