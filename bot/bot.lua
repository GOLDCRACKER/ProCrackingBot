...
function create_config( )
  ...
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    info_text = [[》GOLDCRACKER V1.0
An advanced administration bot based on https://valtman.name/telegram-cli

》https://github.com/GOLDCRACKER/ProCracking

》Admins :
》@typing1 ➣ Founder & Developer《
》@GOLDCRACKER ➣ Developer《
》@Sir_ProgrammER ➣ Developer《

》Special thanks to :
》ProCracking Team Members
